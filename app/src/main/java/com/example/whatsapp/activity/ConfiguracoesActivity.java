...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Botões da interface configurações
    ...
    //recuperar dados, ou seja fotos da camera e/ou galeria
    @Override
            ...
            try {
                switch (requestCode){
                    ...
                    case SELECAO_GALERIA:
                        ...
                        //getContentResolver() - recupera conteúdos do android
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        for (int permissapResultado : grantResults){
            if (permissapResultado == PackageManager.PERMISSION_DENIED){
    ...
    private void alertaValidacaoPermissao(){
        ...
        builder.setCancelable(false);// fecha o Alert apenas se usuario clicar no botão do próprio AlertDialog
